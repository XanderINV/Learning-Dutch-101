...
const lessonExercises: Exercise[] = [
    ...
    skill: 'vocabulary',
    difficulty: 1,
    options: ['News, education, career', 'Only alphabet', 'Only numbers', 'Cooking only'],
    acceptedAnswers: ['News, education, career']
  },
    {
    id: 'b1-04-ex-02',
    moduleId: 'b1-04',
...
const checkpoint: Exercise[] = [
    ...
    skill: 'reading',
    difficulty: 2,
    passage: 'Mijn doel is om beter te argumenteren in het Nederlands. Daarom oefen ik elke week met news.',
    ...
    moduleId: 'b1-04',
    type: 'guided-writing',
    prompt: 'Write a short paragraph (4–5 sentences) on news-career using at least one connector and one complex clause.',
    explanation: 'Self-assess with the checklist.',
    skill: 'writing',
    difficulty: 2,
    modelAnswer: 'Het artikel gaat over klimaatbeleid. Ik wil graag doorgroeien naar een leidinggevende rol. Daarom blijf ik oefenen.',
    checklist: ['Connector or opinion phrase', 'Complex clause (dat/omdat/als/die)', 'On topic']
  }
];

export const moduleB104 = createModule(
  {
    id: 'b1-04',
    level: 'b1',
    title: 'News, education, career',
    titleNl: 'Nieuws, onderwijs, carrière',
    topic: 'news-career',
  ...
  [
    {
      ...
      objective: 'Learn core language for news-career.',
      steps: [
      {
        type: 'explanation',
        title: 'Language tools',
        body: 'Read short news summaries: Volgens het artikel… Education: opleiding, stage, diploma, solliciteren.',
      },
      {
        type: 'examples',
        title: 'In context',
        items: [
          { nl: 'Het artikel gaat over klimaatbeleid.', en: 'The article is about climate policy.' },
          { nl: 'Zij loopt stage bij een museum.', en: 'She is doing an internship at a museum.' }
        ],
      },
      {
        type: 'vocabulary',
      ...
      {
        type: 'exercise',
        exerciseIds: ['b1-04-ex-01', 'b1-04-ex-02', 'b1-04-ex-03', 'b1-04-ex-04', 'b1-04-ex-05'],
      },
      {
        type: 'summary',
        title: 'Quick recap',
        bullets: ['Read short news summaries: Volgens het artikel… Education: opleiding, stage, dip…', 'Practise with short examples daily.'],
      }
      ],
    },
    {
      ...
      objective: 'Practise news-career in short exchanges.',
      steps: [
      {
        type: 'explanation',
        title: 'Putting it together',
        body: 'Career talk: Mijn doel is… Ik wil me ontwikkelen in… Weigh options with liever / eerder / vooral.',
      },
      {
        type: 'examples',
        title: 'More examples',
        items: [
          { nl: 'Ik wil graag doorgroeien naar een leidinggevende rol.', en: 'I would like to progress into a leadership role.' },
          { nl: 'Daarom volg ik een avondcursus.', en: 'That is why I am taking an evening course.' }
        ],
      },
      {
        type: 'vocabulary',
      ...
      {
        type: 'exercise',
        exerciseIds: ['b1-04-ex-06', 'b1-04-ex-07', 'b1-04-ex-08', 'b1-04-ex-09', 'b1-04-ex-10'],
      },
      {
        type: 'summary',
        title: 'Quick recap',
        bullets: ['Career talk: Mijn doel is… Ik wil me ontwikkelen in… Weigh options with liever /…', 'Reuse patterns in your own life.'],
      }
      ],
    }
  ],
...
export const moduleB104Exercises = lessonExercises;
