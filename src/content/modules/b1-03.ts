...
const lessonExercises: Exercise[] = [
    ...
    skill: 'vocabulary',
    difficulty: 1,
    options: ['Workplace communication', 'Only alphabet', 'Only numbers', 'Cooking only'],
    acceptedAnswers: ['Workplace communication']
  },
    {
    id: 'b1-03-ex-02',
    moduleId: 'b1-03',
...
const checkpoint: Exercise[] = [
    ...
    skill: 'reading',
    difficulty: 2,
    passage: 'Mijn doel is om beter te argumenteren in het Nederlands. Daarom oefen ik elke week met workplace.',
    ...
    moduleId: 'b1-03',
    type: 'guided-writing',
    prompt: 'Write a short paragraph (4–5 sentences) on workplace using at least one connector and one complex clause.',
    explanation: 'Self-assess with the checklist.',
    skill: 'writing',
    difficulty: 2,
    modelAnswer: 'De beslissing wordt morgen genomen. Ik stuur de bijlage om te informeren. Daarom blijf ik oefenen.',
    checklist: ['Connector or opinion phrase', 'Complex clause (dat/omdat/als/die)', 'On topic']
  }
];

export const moduleB103 = createModule(
  {
    id: 'b1-03',
    level: 'b1',
    title: 'Workplace communication',
    titleNl: 'Communicatie op het werk',
    topic: 'workplace',
  ...
  [
    {
      ...
      objective: 'Learn core language for workplace.',
      steps: [
      {
        type: 'explanation',
        title: 'Language tools',
        body: 'Passive: De mail wordt vandaag verstuurd. / Het rapport is gisteren afgerond. Useful for minutes and updates.',
      },
      {
        type: 'examples',
        title: 'In context',
        items: [
          { nl: 'De beslissing wordt morgen genomen.', en: 'The decision will be taken tomorrow.' },
          { nl: 'Er wordt vanmiddag vergaderd.', en: 'There will be a meeting this afternoon.' }
        ],
      },
      {
        type: 'vocabulary',
      ...
      {
        type: 'exercise',
        exerciseIds: ['b1-03-ex-01', 'b1-03-ex-02', 'b1-03-ex-03', 'b1-03-ex-04', 'b1-03-ex-05'],
      },
      {
        type: 'summary',
        title: 'Quick recap',
        bullets: ['Passive: De mail wordt vandaag verstuurd. / Het rapport is gisteren afgerond. Us…', 'Practise with short examples daily.'],
      }
      ],
    },
    {
      ...
      objective: 'Practise workplace in short exchanges.',
      steps: [
      {
        type: 'explanation',
        title: 'Putting it together',
        body: 'Om te expresses purpose: Ik bel om te overleggen. Formal email verbs: bevestigen, verzoeken, bijslueten, doorsturen.',
      },
      {
        type: 'examples',
        title: 'More examples',
        items: [
          { nl: 'Ik stuur de bijlage om te informeren.', en: 'I am sending the attachment to inform you.' },
          { nl: 'Kunt u de deadline bevestigen?', en: 'Can you confirm the deadline?' }
        ],
      },
      {
        type: 'vocabulary',
      ...
      {
        type: 'exercise',
        exerciseIds: ['b1-03-ex-06', 'b1-03-ex-07', 'b1-03-ex-08', 'b1-03-ex-09', 'b1-03-ex-10'],
      },
      {
        type: 'summary',
        title: 'Quick recap',
        bullets: ['Om te expresses purpose: Ik bel om te overleggen. Formal email verbs: bevestigen…', 'Reuse patterns in your own life.'],
      }
      ],
    }
  ],
...
export const moduleB103Exercises = lessonExercises;
